...
function DashboardPage(){
  ...
  if (!pair) return <div className="cg-full-center gap-8" data-testid="dashboard-page"><div className="text-center"><h2>No active partnership</h2><p className="cg-muted">Start a connection to begin.</p></div><button onClick={()=>navigate('/invite')} className="cg-btn-primary" data-testid="dashboard-invite-button">Invite a Partner</button></div>;
